...
const AddTweetPanel = () => {
  ...
  return (
    <Menu as="div" className="relative z-40 p-4">
      <Menu.Button as="div">
        <Button size="text-2xl">Agregar tweet</Button>
      </Menu.Button>
      <Transition>
        <Menu.Items className="absolute left-1/2 -translate-x-1/2 bottom-[calc(100%_+_16px)] w-96 p-4 rounded-lg origin-bottom bg-white/90 backdrop-blur shadow-2xl shadow-slate-300">
